...
// below is API SDK that was downloaded
...
const tellMe=(joke)=>{
		...
		VoiceRSS.speech({
            key: 'e8aae887bd974d68a1d0d39a3ee4bd0d',
            src:  `This is Swapnils Robot...........................I will tell you a joke...................................${joke}`,
            hl: 'en-us',
            v: 'Linda',
            r: 0, 
            c: 'mp3',
...
const getJokes = async()=>{
	let joke ='';
	const apiURL = 'https://sv443.net/jokeapi/v2/joke/Programming?blacklistFlags=nsfw,religious,political,racist';
	try{
		...
		// Disable the button while joke is in progress
		toggleButton();		

	} catch(error) {
		//catch Errors
		console.log('whooos',error);
	}
}
